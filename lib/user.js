...
export default class User {
  constructor(client, user) {
    ...
    this.items = {
      ...
      get: (id) => this._client._get(`/items/${id}`),
      ...
      refreshStatus: (id) => this._client.get(`/items/${id}/refresh`, {}, {Authorization: `Bearer ${this.access_token}`}),
  ...
  edit(current_password, new_password) {
    return this._client.put(`/users/${this.user.uuid}`, {current_password, new_password});
  }

  delete(password) {
    return this._client.delete(`/users/${this.user.uuid}`, {password});
  }
}
